...
// FFT data
string g_program_version = "1.0.0.7";

const unsigned int meshSizeX = 256;//4;//32 196;
const unsigned int meshSizeY = 256;//4;//32 196;

string g_U_matrix_fileName = "U8.txt";
string g_D_matrix_fileName = "D8_10000.txt";
string g_W_matrix_fileName = "W8_1cycle.txt";
string g_WD_matrix_fileName = "WD8_1cycle.txt";
string g_E_matrix_fileName = "E0.txt";
string g_G_fileName = "G.txt";
string g_Indxs_fileName = "indxs.txt";
string g_UL_filename = "UL8_10000_E0.txt";
...
string g_P_matrix_at_step = "P8_first_step.txt"; //filename to save P matrix at step defined by g_PrintPropogateMatrixStepNum
string g_UL_matrix_at_step = "UL8_first_step.txt";//filename to save UL matrix at step defined by g_PrintPropogateMatrixStepNum
...
////////////////////////////// MAIN LOOP //////////////////////////////////////
    ...
    for (int i = 0; i < g_number_of_cycles; i++)
    {
        ...
        // Launch a kernel on the GPU with one thread for each element. 
                              //4
        mulKernelComplex << < 4, meshSizeX >> > (meshSize1D, d_WD, d_W, d_Difract, g_UseMultiplication); //32
        ...
        {                          //4                              // result of division    
            divKernelComplex << < 4, meshSizeX >> > (meshSize1D, d_Temp, d_Uinverse, meshSize1D);//final result is in d_U 
        }
        else
        {
        ...
        //mul by E0
        mulKernelComplex << < 4, meshSizeX >> > (meshSize1D, d_Temp2, d_Temp, d_E, g_UseMultiplication);
        mulKernelComplex << < 4, meshSizeX >> > (meshSize1D, d_U, d_Temp2, d_P, g_UseMultiplication);
